export const COLORS = {
  ...
  bg2: "#111111",
  green: "#00ff88",
  greenDim: "rgba(0,255,136,0.27)",
  greenFaint: "rgba(0,255,136,0.07)",
  amber: "#ffb700",
  white: "#e8e8e8",
  grey: "#555",
  border: "#1e1e1e",
...
export const SKILLS = [
  ...
  { label: "Python", pct: 75 },
  { label: "SQL / PostgreSQL", pct: 70 },
  { label: "Git / DevOps", pct: 78 },
];

export const CONTACT_LINKS = [
  { icon: "@", label: "emiliofav@gmail.com", href: "mailto:emiliofav@gmail.com" },
  { icon: "gh", label: "github.com/efayadv", href: "https://github.com/efayadv" },
];
